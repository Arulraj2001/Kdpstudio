...
async function run() {
  ...
  ['sw.js', 'firebase-messaging-sw.js', 'manifest.json', 'site.webmanifest', 'og-image.png', 'og-image.svg', 'brand-icon.png', 'logo.png', 'llms.txt', 'kdpstudio-indexnow-key-2026.txt', 'ads.txt'].forEach(file => {
