          ...
          <>
            ...
            {isText && (
              <div className="space-y-4">
                {/* Font Pairings Quick Preset */}
                <div>
                  <label className="block text-[11px] font-bold text-purple-700 uppercase tracking-wider mb-1.5 flex items-center gap-1">
                  ...
                  <select
                    ...
                    defaultValue=""
                    className="w-full px-3 py-2 bg-purple-50/70 border border-purple-200 rounded-xl text-xs font-semibold text-purple-900 focus:outline-none focus:ring-1 focus:ring-purple-500"
                  >
                    <option value="" disabled>Choose a Genre Font Pairing...</option>
                    <option value="Cinzel">Cinzel (Fantasy / Sci-Fi)</option>
                    <option value="Playfair Display">Playfair Display (Romance / Fiction)</option>
                    <option value="Oswald">Oswald (Thriller / Crime)</option>
                    <option value="Anton">Anton (Business / Self-Help)</option>
                    <option value="Cormorant Garamond">Cormorant Garamond (Poetry / Memoir)</option>
                    <option value="Cinzel Decorative">Cinzel Decorative (Gothic / Fantasy)</option>
                  </select>
                </div>
                ...
                <div className="flex items-center gap-1.5 bg-slate-100 p-1 rounded-xl">
                  <button
                    ...
                    onClick={() => {
                      if (selectedObject?.text) {
                        onUpdateObject({ text: selectedObject.text.toUpperCase() });
                      }
                    }}
                    className="flex-1 py-1 rounded-lg text-[10px] font-bold text-slate-700 hover:bg-slate-200 cursor-pointer text-center"
                  >
                    UPPERCASE
                  </button>
                  <button
                    ...
                    onClick={() => {
                      if (selectedObject?.text) {
                        const titleCased = selectedObject.text.replace(
                          /\w\S*/g,
                          (txt: string) => txt.charAt(0).toUpperCase() + txt.substr(1).toLowerCase()
                        );
                        onUpdateObject({ text: titleCased });
                      }
                    }}
                    className="flex-1 py-1 rounded-lg text-[10px] font-bold text-slate-700 hover:bg-slate-200 cursor-pointer text-center"
                  >
                  ...
                  <button
                    ...
                    onClick={() => {
                      if (selectedObject?.text) {
                        onUpdateObject({ text: selectedObject.text.toLowerCase() });
                      }
                    }}
                    className="flex-1 py-1 rounded-lg text-[10px] font-bold text-slate-700 hover:bg-slate-200 cursor-pointer text-center"
                  >
