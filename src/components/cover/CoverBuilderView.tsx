...
export const CoverBuilderView: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-full bg-[#f8fafc] dark:bg-[#0d0d16] text-gray-900 dark:text-gray-100 overflow-hidden select-none">
      ...
      <div className="flex-1 flex overflow-hidden relative">
        ...
        <div
          ...
          className="flex-1 relative flex flex-col items-center justify-center bg-gray-100 dark:bg-[#0b0b12] overflow-auto p-8"
        >
          ...
          <div
            className="flex items-center justify-between text-[11px] font-bold uppercase tracking-widest text-gray-400 dark:text-gray-500 mb-2 pointer-events-none transition-all"
            style={{
              width: `${canvasWidthPx * zoomLevel}px`,
            }}
          >
            <div className="text-center flex-1">Back Cover</div>
            <div className="text-center px-2 text-purple-600 dark:text-purple-400 font-mono">
              Spine ({coverDims.spineWidth}")
            </div>
            <div className="text-center flex-1">Front Cover</div>
          </div>

          {/* Scaled Canvas Container with Guides */}
          <div
            className="relative shadow-2xl rounded-sm transition-transform duration-75 origin-top-left"
            style={{
              width: `${canvasWidthPx * zoomLevel}px`,
          ...
          <div className="mt-4 flex items-center gap-4 text-xs text-gray-500 dark:text-gray-400 font-mono bg-white/70 dark:bg-[#131320]/70 px-4 py-1.5 rounded-full border border-gray-200 dark:border-gray-800 shadow-2xs backdrop-blur-xs">
            <span>
              Total: <strong>{coverDims.totalWidth}" × {coverDims.totalHeight}"</strong> ({canvasWidthPx} × {canvasHeightPx} px)
            </span>
            <span>•</span>
            <span>
              Spine: <strong className="text-purple-600 dark:text-purple-300">{coverDims.spineWidth}"</strong> ({pageCount}p, {paperType})
            </span>
            <span>•</span>
            <span>Trim: <strong>{trimSize}</strong></span>
          </div>
        </div>
      ...
      <footer
        id="cover-bottom-bar"
        className="h-14 bg-white dark:bg-[#131320] border-t border-gray-200 dark:border-gray-800 px-6 flex items-center justify-between z-30 select-none shrink-0"
      >
        ...
        <div className="flex items-center gap-2 bg-gray-50 dark:bg-gray-800/60 p-1 rounded-xl border border-gray-200 dark:border-gray-700">
          <button
            type="button"
          ...
          <span className="font-mono text-xs font-bold text-gray-800 dark:text-gray-200 px-2 min-w-14 text-center">
          ...
          <button
            ...
            title="Fit to Screen"
            className="px-2 py-1 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-lg text-[11px] font-semibold text-gray-600 dark:text-gray-300 flex items-center gap-1"
          >
