...
const ROUTE_TITLES: Record<PageRoute, { title: string; subtitle: string }> = {
  ...
  features: { title: 'Platform Features', subtitle: 'Complete Amazon KDP creator toolkit' },
  pricing: { title: 'Pricing Plans', subtitle: 'Simple, transparent creator pricing' },
  tools: { title: 'Free Tools Hub', subtitle: 'Calculators, generators, and research engines' },
  'arc-lounge': { title: 'ARC Reader Lounge', subtitle: 'Advance review copy discovery and requests' },
  'arc-manager': { title: 'ARC Campaign Manager', subtitle: 'Manage reviewers, distribution, and verified review tracking' },
  'newsletter-swaps': { title: 'Newsletter Swaps', subtitle: 'Cross-promotions with other indie authors' },
  ...
  'royalty-calculator': { title: 'Royalty Calculator', subtitle: 'Calculate net royalties and print costs across 13 marketplaces' },
  'asin-spy': { title: 'Reverse ASIN Spy', subtitle: 'Competitor sales velocity and daily orders estimator' },
  'review-miner': { title: 'Review Pain Point Miner', subtitle: 'Analyze negative reviews to find market opportunities' },
  'lead-magnet': { title: 'Lead Magnet QR Studio', subtitle: 'Generate 300 DPI reader bonus pages and dynamic QR codes' },
  'maze-generator': { title: 'Maze Generator', subtitle: 'Algorithmic circular, diamond, and grid mazes' },
  'cryptogram-generator': { title: 'Cryptogram Generator', subtitle: 'Letter substitution cipher puzzle books' },
  'sudoku-generator': { title: 'Sudoku Generator', subtitle: 'Classic 9x9 Sudoku books with answer keys' },
  'crossword-generator': { title: 'Crossword Generator', subtitle: 'Clued crossword puzzle books' },
  'childrens-book-studio': { title: 'Children\'s Book Studio', subtitle: 'Illustrated picture books with character consistency' },
  'cookbook-studio': { title: 'Cookbook Studio', subtitle: 'Recipe books with ingredient grids and nutrition' },
  'planner-studio': { title: 'Planner Studio', subtitle: 'Daily, weekly, and monthly undated planners' },
  'nonfiction-studio': { title: 'Non-Fiction Studio', subtitle: 'Frameworks, blueprints, and instructional guides' },
  'fiction-studio': { title: 'Fiction Studio', subtitle: '15-Beat novel structuring and character arcs' },
  'workbook-studio': { title: 'Workbook Studio', subtitle: 'Interactive fill-in workbooks with reflection exercises' },
  'admin-limits': { title: 'Plan Limits & Quotas', subtitle: 'Dynamic tier limits and quota management' },
  'admin-seo': { title: 'SEO & Meta Manager', subtitle: 'Site-wide meta tags and search indexing' },
