...
export async function POST(req: Request) {
  try {
    ...
    try {
      ...
      return new Response(html, {
        headers: {
          ...
          'Content-Disposition': `attachment; filename="${book.settings.title || 'coloring_book'}.html"`,
        },
      });
    }
    ...
    const safeTitle = (book.settings.title || 'coloring_book')
      .toLowerCase()
      .replace(/[^a-z0-9]/g, '_');
    ...
    console.error('Coloring PDF export error:', err);
