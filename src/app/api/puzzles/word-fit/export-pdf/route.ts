...
export async function POST(req: Request) {
  try {
    ...
    try {
      ...
      return new Response(html, {
        headers: {
          ...
          'Content-Disposition': `attachment; filename="${book.settings.title || 'word_fit'}.html"`,
        },
      });
    }
    ...
    const safeTitle = (book.settings.title || 'word_fit')
      .toLowerCase()
      .replace(/[^a-z0-9]/g, '_');
    ...
    console.error('Word fit PDF export error:', err);
